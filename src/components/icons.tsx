...
// Feather "map" — the "explore map" (play) button.
export const Map = () => (
...
// Feather "download" — the full-sprite download button.
...
// Feather "grid" / "list" — the catalogue's view toggle.
export const Grid = () => (
  <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
// Feather "shopping-cart" — the market link on wishlist rows and list tiles.
export const Cart = () => (
